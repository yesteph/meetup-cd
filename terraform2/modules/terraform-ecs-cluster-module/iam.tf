...
resource "aws_iam_role_policy_attachment" "ecs_instance_role_policy_attach_SSM" {
  role       = "${aws_iam_role.ecs_instance_role.name}"
...
resource "aws_iam_instance_profile" "ecs_container_instance_profile" {
  ...
  depends_on = ["aws_iam_role_policy_attachment.ecs_instance_role_policy_attach",
    "aws_iam_role.ecs_instance_role", "aws_iam_role_policy_attachment.ecs_instance_role_policy_attach_SSM"
  ]
}
