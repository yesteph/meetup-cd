locals {
  ...
  blue_lb_dns                = "${data.consul_keys.blue_components.var.blue_env == "a" ? module.alb-a.dns_name : module.alb-b.dns_name}"
  green_lb_dns               = "${data.consul_keys.blue_components.var.blue_env == "a" ? module.alb-b.dns_name : module.alb-a.dns_name}"
  blue_lb_dns_zone_id        = "${data.consul_keys.blue_components.var.blue_env == "a" ? module.alb-a.dns_alb_zone_id : module.alb-b.dns_alb_zone_id}"
  green_lb_dns_zone_id       = "${data.consul_keys.blue_components.var.blue_env == "a" ? module.alb-b.dns_alb_zone_id : module.alb-a.dns_alb_zone_id}"
