$(document).ready(function() {
  ...
  (function setElementsColor(color) {
    ...
    clearElement.css("background-color", color);
  })(randomColor);

  submitElement.click(handleSubmission);
  clearElement.click(handleClear);
  ...
  (function fetchVersion() {
    $.getJSON("version").done(setVersion).always(
      function() {
